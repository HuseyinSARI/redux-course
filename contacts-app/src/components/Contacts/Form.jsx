    ...
    return (
        <div className='flex flex-col'>
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
                <input className=" p-2 rounded" placeholder='Name' value={name} onChange={e => setName(e.target.value)} />
                <input className=" p-2 rounded" placeholder='Phone Number' value={number} onChange={e => setNumber(e.target.value)} />
